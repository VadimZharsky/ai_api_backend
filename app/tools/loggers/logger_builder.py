...
class LoggerBuilder:
    def __init__(self, logger_name: str, logger_lvl: int = logging.ERROR) -> None:
        LoggerBuilder.check_path(logger_name)
        self.format: str = "%(asctime)s - %(levelname)s - %(message)s"
        self.file_name: str = f"logs/{logger_name}/{logger_name}.log"
        self.logger_name: str = logger_name
        self._logger: Logger = logging.getLogger(logger_name)
